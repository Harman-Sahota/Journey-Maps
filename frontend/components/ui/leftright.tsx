        ...
        <div>
            <div className="flex flex-col md:flex-row items-center justify-center mt-10">
                ...
                <Image
                    ...
                    width={300}
                    height={300}
                    className="rounded-lg md:ml-8 mt-4 md:mt-0 dark:brightness-75"
                    alt="Stairs Symbolzing person making progres"
                />
            </div>
            <div className="flex flex-col md:flex-row-reverse items-center justify-center mt-8">
                ...
                <Image
                    ...
                    width={300}
                    height={300}
                    className="rounded-lg md:mr-8 mt-4 md:mt-0 dark:brightness-75"
                    alt="Stairs Symbolzing person making progress"
                />
            </div>
            <div className="flex flex-col md:flex-row items-center justify-center mt-8">
                ...
                <Image
                    ...
                    height={300}
                    className="rounded-lg md:ml-8 mt-4 md:mt-0 dark:brightness-75"
                    alt="A hand reaching another: signifying community support"
                />
            </div>
            <div className="flex flex-col md:flex-row-reverse items-center justify-center mt-8">
                <div className="max-w-lg">
                ...
                <Image
                    ...
                    height={300}
                    className="rounded-lg md:mr-8 mt-4 md:mt-0 dark:brightness-75"
                    alt="a duck following another duck in a body of water"
                />
            </div>
        </div>
    );
